$(document).ready(function () {
  $.getJSON("js/dashboard.json", function (data) {
    ...
    var y = [
      data.Ug_std_by_course[0],
      data.Ug_std_by_course[1],
      data.Ug_std_by_course[2],
      data.Ug_std_by_course[3],
    ];
    var barcolors = ["green", "blue", "violet", "yellow"];
